...
namespace jetblack::io
{
  ...
  public:
    ...
    int fd() const noexcept { return stream_.socket->fd(); }
    bool is_open() const noexcept { return stream_.socket->is_open(); }
    bool want_read() const noexcept { return is_open() || stream_.want_read(); }
    bool want_write() const noexcept { return is_open() && (!write_queue_.empty() || stream_.want_write()); }
    ...
    std::optional<std::vector<char>> dequeue() noexcept
    {
    ...
    void enqueue(const std::vector<char>& buf) noexcept
    {
